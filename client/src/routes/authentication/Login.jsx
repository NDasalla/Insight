...
function Login() {
  ...
  return (
    <Form
      ...
      style={{
        "--image-url": `url("https://rare-gallery.com/uploads/posts/508158-advice-advise.jpg")`,
      }}
    ...
    >
      <div className="w-full h-full flex justify-center items-center backdrop-blur-[1px]">
        <div className="bg-[#000000ea] shadow-[0px_0px_14px_rgba(0,0,0,1)] rounded-lg px-16 py-12 grid justify-items-center gap-6">
